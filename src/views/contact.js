                    ...
                    <div className="contactus">
                        <div className="contact">
                            ...
                            <div className="social-media">
                                <h2>Umuringa Fashion, Kigali Gikondo, Rwanda</h2>
                                <h2>tel:+250787735301</h2>
                                <h2>umuringabrand@fashion.com</h2>
                                <div className="social">
                                    <span className='circum'><a href="https://www.facebook.com/anaclet.art/"><FacebookOutlined /></a></span>
                                    <span className='circum'><a href="https://www.linkedin.com/in/tuyishime-anaclet-04421a230/?originalSubdomain=rw"><LinkedinOutlined /></a></span>
                                    <span className='circum'><a href="https://www.instagram.com/umuringa_fashion_code/"><InstagramOutlined /></a></span>
                                    <span className='circum'><a href="https://web.whatsapp.com/"><WhatsAppOutlined /></a></span>
                                </div>
                            </div>
                        </div>
